...
export type ContactCallDocument = HydratedDocument<ContactCall>;

@Schema({ versionKey: false, timestamps: true })
export class ContactCall extends AbstractSchema {
  @Prop({ required: true })
  title?: string;
...
export const ContactCallSchema = SchemaFactory.createForClass(ContactCall);
