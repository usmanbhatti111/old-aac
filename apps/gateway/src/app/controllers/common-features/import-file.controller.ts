...
import { ActivityLogParams, ImportFileDTO, ImportFileResponseDto } from '@shared/dto';
  ...
  public async createImportFile(
    ...
    try {
      ...
      if (response?.data) {
        ...
        firstValueFrom(
          this.commonFeatureServiceClient.send(RMQ_MESSAGES.ACTIVITY_LOG.ACTIVITY_LOG, {
            ...params,
          })
        );
